...
public class ClientAPI_TunBuilderBase {
  ...
  public boolean tun_builder_add_dns_options(SWIGTYPE_p_openvpn__DnsOptions dns) {
    return ovpncliJNI.ClientAPI_TunBuilderBase_tun_builder_add_dns_options(swigCPtr, this, SWIGTYPE_p_openvpn__DnsOptions.getCPtr(dns));
  }
